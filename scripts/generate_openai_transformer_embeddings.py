...
def main(input_path: str,
    ...
    split_sentences = [[Token(word) for word in sentence.split()] for sentence in sentences]
...
def embed_sentences(indexer: OpenaiTransformerBytePairIndexer,
    ...
    for batch in lazy_groups_of(iter(sentences), batch_size):
        ...
        positional_encodings = get_range_vector(512, device=get_device_of(inputs)) + 768
...
if __name__ == "__main__":
    ...
    parser.add_argument("--forget_sentences", type=bool, default=False)
