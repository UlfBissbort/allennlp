...
python -m allennlp.run evaluate \
    --evaluation-data-file ~/data/ner/eng.testb.json \
    https://s3-us-west-2.amazonaws.com/allennlp/models/ner-model-2017.11.15.tar.gz \
    -o '{"dataset_reader": { "type": "conll2003-json" } }' \
    --include-package allennlp.data.dataset_readers.conll2003_json

python -m allennlp.run evaluate \
    --evaluation-data-file ~/data/ner/eng.testb.json \
    https://s3-us-west-2.amazonaws.com/allennlp/models/ner-model-2018-02-12.tar.gz \
    -o '{"dataset_reader": { "type": "conll2003-json" } }' \
    --include-package allennlp.data.dataset_readers.conll2003_json
"""
...
@DatasetReader.register("conll2003-json")
